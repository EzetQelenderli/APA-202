...
namespace _27_FrontToBackSqlConnectionn.Migrations
{
    ...
    [Migration("20260525164033_createidentityTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_27_FrontToBackSqlConnectionn.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("_27_FrontToBackSqlConnectionn.Models.ProductTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_27_FrontToBackSqlConnectionn.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("_27_FrontToBackSqlConnectionn.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("_27_FrontToBackSqlConnectionn.Models.ProductTag", b =>
                {
                    ...
                    b.HasOne("_27_FrontToBackSqlConnectionn.Models.Tag", "Tag")
                        .WithMany("ProductTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
